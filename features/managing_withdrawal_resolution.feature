...
Feature: Resolving a pre-shipment cancellation request
    In order to stay in control of refunds and stock
    As an Administrator
    I want to confirm a pre-shipment cancellation request or redirect it into the return process
    ...
    Background:
        ...
        And I have order return with number "R000000010-1" and status "cancellation_request" for latest order
        And I am logged in as an administrator

    @ui
    Scenario: Confirming a cancellation request cancels the return
