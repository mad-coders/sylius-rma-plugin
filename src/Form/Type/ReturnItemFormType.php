        ...
        $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event): void {
            ...
            $form->add('returnQty', IntegerType::class, [
                ...
                'constraints' => [
                    ...
                    new GreaterThanOrEqual(value: 0, message: 'madcoders_rma.validator.return_qty_greater_or_equal'),
                    new LessThanOrEqual(value: $returnItem->getMaxQty(), message: 'madcoders_rma.validator.return_qty_less_or_equal'),
                ],
            ]);
        });
    }
